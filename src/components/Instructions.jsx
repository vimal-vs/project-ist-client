  ...
  return (
    <div className="flex flex-col gap-3 px-2 my-6 md:my-12">
      ...
      <div className="flex flex-col gap-2 mt-3">
        ...
        <button onClick={redirectJPG} className="w-max underline font-semibold text-blue-900 text-sm md:text-base">Link to Compress your JPGs</button>
      </div>
      <div className="flex flex-col gap-2">
        ...
        <button onClick={redirectPDF} className="w-max underline font-semibold text-blue-900 text-sm md:text-base">Link to Compress your PDFs</button>
